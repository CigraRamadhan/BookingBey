...
<div class="row">
            ...
            <div class="card-body">
                @if($lapangan->gambar)
                    <img src="{{ asset('storage/' . $lapangan->gambar) }}" 
                         class="img-fluid rounded mb-3" alt="{{ $lapangan->nama }}">
                @endif
                ...
                <div class="row mt-3">
                    <div class="col-md-6">
                        <div class="info-box">
                            ...
                            <span class="ms-2">Harga: Rp {{ number_format($lapangan->harga_per_jam, 0, ',', '.') }}/jam</span>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="info-box">
    ...
    <div class="col-md-4">
        <div class="card">
            ...
            <div class="card-body">
                @if($lapangan->status === 'available')
                    <a href="{{ route('user.booking.create', $lapangan->id) }}" 
